        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-earth-700 text-base sm:text-lg leading-relaxed">
              Founded on the principles of natural pasture feeding and humane animal care, Farm Fresh Dairy Products began with a simple belief: pure milk should reach families exactly as nature created it.
            </p>
