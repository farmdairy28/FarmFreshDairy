...
export const INITIAL_DELIVERY: DeliveryRegion[] = [
  {
    ...
    is_active: true,
    areas: [
      { id: 'da14', name: 'Shahzad Town (FREE Doorstep Delivery)', delivery_fee: 0, timing_info: 'FREE Doorstep Delivery · Morning & Evening', sort_order: 1, is_active: true },
      { id: 'da15', name: 'Chak Shahzad Farm Houses & Park Road', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 2, is_active: true },
      { id: 'da16', name: 'Park View City & Bani Gala Surrounds', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 3, is_active: true },
      { id: 'da17', name: 'Naval Anchorage & Gulberg Greens', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 4, is_active: true },
    ]
  },
  {
    id: 'dr2',
    ...
    is_active: true,
    areas: [
      { id: 'da1', name: 'F-6 (Super Market & Embassy Area)', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 1, is_active: true },
      { id: 'da2', name: 'F-7 (Jinnah Super & Surrounds)', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 2, is_active: true },
      { id: 'da3', name: 'F-8 & F-10 Sectors', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 3, is_active: true },
      { id: 'da4', name: 'F-11 (Markaz & Residential Blocks)', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 4, is_active: true },
    ]
  },
  {
    id: 'dr3',
    ...
    is_active: true,
    areas: [
      { id: 'da5', name: 'E-7 & E-11 (FECHS / MPCHS)', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 1, is_active: true },
      { id: 'da6', name: 'G-6, G-7 & G-8 Sectors', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 2, is_active: true },
      { id: 'da7', name: 'G-9, G-10 & G-11 Sectors', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 3, is_active: true },
    ]
  },
  {
    id: 'dr4',
  ...
  },
  {
    ...
    is_active: true,
    areas: [
      { id: 'da10', name: 'DHA Phase 1 & Phase 2', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 1, is_active: true },
      { id: 'da11', name: 'DHA Phase 3, 5 & Valley', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 2, is_active: true },
      { id: 'da12', name: 'Bahria Town Phase 1-8', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 3, is_active: true },
      { id: 'da13', name: 'Bahria Enclave Islamabad', delivery_fee: 0, timing_info: 'Delivered via Rider (Charges as per Rider)', sort_order: 4, is_active: true },
    ]
  }
];
...
export const INITIAL_TESTIMONIALS: Testimonial[] = [
  {
    ...
    customer_type: 'Family Physician (F-7 Islamabad)',
    review: 'The difference in purity and aroma between supermarket milk and Farm Fresh Dairy Products is astounding. The lab test report gives complete peace of mind, and our morning tea finally tastes like authentic pure milk.',
  ...
  },
  {
    ...
    review: 'Their desi ghee and whole cow milk at Rs. 250 are unmatched. In pastry making, ingredient consistency is key, and Farm Fresh Dairy delivers 100% pure quality every single morning without fail.',
  ...
  },
  {
    id: 't4',
    rating: 5,
    customer_name: 'Usman Qureshi',
    customer_type: 'Resident (I-8/3 Islamabad)',
    review: 'Free delivery to I-8 is a game changer! The milk arrives fresh, ice-cold, and unboiled. When you boil it at home, the natural sweet scent fills the whole kitchen.',
  ...
  },
  {
    id: 't5',
    rating: 5,
    customer_name: 'Mrs. Farhana Bilal',
    customer_type: 'Resident (I-9 Sector)',
    review: 'Tested their milk for adulteration using a home lactometer test and it passed with flying colors! Great to see free doorstep delivery in I-9 now too.',
  ...
  },
  {
    id: 't6',
    rating: 5,
    customer_name: 'Major (R) Kamran',
    customer_type: 'Resident (DHA Phase 2)',
    review: 'Consistent morning delivery before breakfast. The bilona desi ghee and unpasteurized raw cow milk are of top-tier organic standards. Highly recommended!',
