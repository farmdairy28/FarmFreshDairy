export function renderEmailFooter(): string {
  return `
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #F8FAF9; border-bottom-left-radius: 16px; border-bottom-right-radius: 16px; border-top: 1px solid #E5ECE8; margin-top: 24px;">
      <tr>
        <td style="padding: 24px; text-align: center; font-family: 'Helvetica Neue', Arial, sans-serif;">
          <p style="margin: 0 0 8px 0; font-size: 13px; font-weight: bold; color: #1B4D3E;">
            Farm Fresh Dairy
          </p>
